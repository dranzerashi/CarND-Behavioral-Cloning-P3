...
model.fit_generator(train_generator, samples_per_epoch=len(training_samples)*2, validation_data=validation_generator, nb_val_samples=len(validation_samples)*2,nb_epoch=9)
model.save('model.h5')
